...
cd $BUILD_DIR
cmake $PROJECT_DIR -G Xcode -DCMAKE_TOOLCHAIN_FILE=$CMAKE_TOOLCHAIN_FILE -DIOS_DEPLOYMENT_TARGET=11.0 -DPLATFORM=OS64 -DTFLITE_ENABLE_XNNPACK=OFF -DFLATBUFFERS_BUILD_TESTS=OFF -DFLATBUFFERS_INSTALL=OFF
